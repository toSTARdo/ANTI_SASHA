...
BAD_WORDS = [
    ...
    "ублюдок", "ублюдки", "падло", "падлюка", "лох",
    "гандон", "гандони", "підарас", "підараси", "чмо",
    # english
...
async def show_karma(message: types.Message):
    if karma == 0:
        ...
        await message.answer(f"☢️ Карма Саші: {karma}. Качка дед інсайд.")
